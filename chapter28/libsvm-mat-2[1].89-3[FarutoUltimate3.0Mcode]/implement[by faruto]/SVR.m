...
% Method_option.type = 1[grid] or 2[ga] or 3[pso] or 4
%
% ====================output=================
...
if Method_option.type == 1
    [bestCVmse,bestc,bestg] = SVMcgForRegress(TrainL,Train,-8,8,-8,8,5,0.5,0.5)
...
if Method_option.type == 2
    ...
    cmd = ['-c ',num2str(bestc),' -g ',num2str(bestg),' -s 3 -p 0.001'];
end
